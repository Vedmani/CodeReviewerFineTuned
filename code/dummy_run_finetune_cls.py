...
def get_loaders(data_files, args, tokenizer, pool, eval=False):
    ...
    for data_file in data_files:
        ...
        dataloader = DataLoader(dataset, sampler=None, batch_size=args.train_batch_size if not eval else args.eval_batch_size, \
...
def main(args):
    ...
    args.world_size = 1
    logger.warning("BS: %s", args.train_batch_size)
    torch.device('cuda')
